...
/* Maksimum cache alokasi untuk struktur futex */
#define IO_FUTEX_ALLOC_CACHE_MAX	32

/*
 * Mengalokasikan cache untuk struktur futex_data untuk mengurangi alokasi dinamis.
 *
...
/**
 * io_futex_cache_free - Membersihkan cache alokasi futex
 * @ctx: Konteks io_uring
 *
 * Membebaskan semua memori yang dialokasikan untuk cache futex.
 */
...
/*
 * Membersihkan state async dan menghapus dari hash list sebelum menyelesaikan.
 */
...
/*
 * Menyelesaikan operasi futex tunggal dengan membersihkan cache dan state.
 */
...
/*
 * Menyelesaikan operasi futex vector dengan membersihkan state dan memori.
 */
...
/*
 * Menggunakan atomic bitops untuk mengklaim kepemilikan futex vector.
 *
 * Return: true jika berhasil mengklaim, false jika sudah dimiliki
 */
...
/*
 * Membatalkan operasi futex baik untuk mode tunggal maupun vector.
 *
 * Return: true jika berhasil dibatalkan, false jika tidak
 */
...
/*
 * Mencari dan membatalkan operasi futex yang cocok dengan kriteria.
 *
 * Return: Jumlah yang dibatalkan atau error code
 */
...
/*
 * Membersihkan semua operasi futex yang terkait dengan task tertentu.
 *
 * Return: true jika ditemukan yang dibatalkan, false jika tidak
 */
...
/*
 * Memvalidasi dan mengekstrak parameter untuk operasi futex dasar (wait/wake).
 *
 * Return: 0 jika sukses, error code jika tidak valid
 */
...
/*
 * Callback yang dipanggil ketika futex vector diwakeup.
 */
...
/*
 * Memvalidasi dan menyiapkan operasi wait pada multiple futex.
 *
 * Return: 0 jika sukses, error code jika tidak valid
 */
...
/*
 * Callback yang dipanggil ketika futex tunggal diwakeup.
 */
...
/*
 * Implementasi operasi wait untuk multiple futex address.
 *
 * Return: IOU_ISSUE_SKIP_COMPLETE jika async, IOU_OK jika selesai
 */
...
/*
 * Implementasi operasi wait untuk single futex address.
 *
 * Return: IOU_ISSUE_SKIP_COMPLETE jika async, IOU_OK jika selesai
 */
...
/*
 * Implementasi operasi wake untuk membangunkan waiter pada futex address.
 *
 * Return: IOU_OK setelah selesai
 */
